...
public class pyGramLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ASSIGNMENT", "GT", "LT", "GE", "LE", "EQ", "NE", "PLUS", "MINUS", "TIMES", 
			"DIVIDES", "COMMA", "COLON", "SEMI_COLON", "OPEN", "CLOSE", "BRACKET", 
			"OR", "AND", "NOT", "FOR", "BREAK", "IF", "ELSE", "WHILE", "IN", "DEF", 
			"MAIN", "RETURN", "VOID", "TYPE", "PRINT", "INPUT", "RANGE", "INT_VALUE", 
	...
	public pyGramLexer(CharStream input) {
		super(input);
